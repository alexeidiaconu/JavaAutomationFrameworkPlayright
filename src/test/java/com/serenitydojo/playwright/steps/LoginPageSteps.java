...
public class LoginPageSteps {
    ...
    LoginPage loginPage =  scenarioContext.getScenarioContext(LOGIN_PAGE);
    AdminUser adminUser =  scenarioContext.getScenarioContext(ADMIN_USER);
    ...
    public void validCredentialsArePopulatedInTheUsernameAndPasswordFields() {
        ...
        loginPage.waitForPageToBeVisible();
